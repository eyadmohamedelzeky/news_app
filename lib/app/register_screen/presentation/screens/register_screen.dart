                      ...
                      child: Column(
                        ...
                        children: [
                          CustomTextFormField(
                            ...
                            labelText: context.localization.email, // 'Email',
                            hintText: context
                                .localization.hint_email, //'Type your email',
                          ),
                          SizedBox(
                            height: 10.h,
                          ),
                          BlocBuilder<VisiablePasswordCubit,
                            ...
                            builder: (context, state) {
                              ...
                              return CustomTextFormField(
                                ...
                                labelText:
                                    context.localization.password, //'Password',
                          ...
                          CustomRawMaterialButton(
                            textButton:
                                context.localization.register, //'Register',
                            onPressed: () async {
                              if (formKey.currentState!.validate()) {
                                try {
                                  await registerUser();
                                } on FirebaseAuthException catch (e) {
                                  debugPrint('The Error Coming from ${e.code}');
